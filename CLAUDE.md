...
- Page headers and the app navbar use Forest Green (#1A4D2E) with white text
- Primary action buttons (Create Order, Save) use Safety Amber (#D97706) with white text
- Status badges use color coding: green for Running, amber for Pending, red for Down/Blocked, gray for Complete
- Card backgrounds are white with Light Gray borders
- Page background is Light Sage (#F0F4F1)
